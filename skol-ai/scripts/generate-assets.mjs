...
const ogPages = [
  ...
  { file: "ai-fotografija", eyebrow: "Storitev", title: "Vizualije, ki ne obstajajo nikjer drugje." },
  { file: "oglasne-kreative", eyebrow: "Storitev", title: "Estetika, ki ustavi palec." },
  { file: "virtualni-vplivnezi", eyebrow: "Storitev", title: "Obraz vaše znamke, ki nikoli ne odpove." },
  { file: "showroom", eyebrow: "Showroom", title: "Kjer povprečje umre." },
